...
var firebaseConfig = {
  ...
  $(document).on("submit", "#profile", function(e) {
    ...
    e.preventDefault();
    console.log("Flag is:"+flag+" nv = "+nullValues+" mn = " + mobilenumber )
  ...
  var protocol = 'HLS';
      ...
      var streamName = 'iotvideo';

        // Step 1: Configure SDK Clients
        var options = {
          // accessKeyId: 'AKIAWZWHC4N233IMV4HK',
          accessKeyId: 'AKIAQV4DLAME67FY25WF',
          // secretAccessKey: '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',
          secretAccessKey: '/ST9fBEQCS+V3L8sf9Aunh5qgOZBRl/NZerTHfkL',
          sessionToken: undefined,
          // region: 'ap-south-1',
          region: 'us-east-1',
          endpoint: undefined
        }
        // arn:aws:kinesisvideo:us-east-1:046983217929:stream/iotvideo/1650866122313
        ...
        // Step 2: Get a data endpoint for the stream
          ...
          kinesisVideo.getDataEndpoint({
            ...
            if (err) { return console.error("KKKKK",err); }
